---
title: "yangy22_FinalHomeworkCode_01"
author: "Emily Yang"
date: "`r Sys.Date()`"
output:
...
<br> [1] "/Library/Frameworks/R.framework/Versions/4.3-arm64/Resources/library/tidyr" or<br> [1] "" = package not installed.<br>
...
## Commentary 
<br>
1. I liked how other people used the seq() function to segment their code. I will experiment with it. I also liked seeing different commenting styles. I over explained in my comments because I know that I will forget quickly.<br>
2. I didn't really have anything that needed improvements. Mainly it was the extra packages I loaded that caused issues when Amanda tried to run my code.<br>
3. I had problems splitting the sentence in challenge 1 to a matrix of 8X3 because there were only 22 words. I went to office hours and got help on fixing it. <br>
4. The comments helped me be more conscious of how I'm commenting on my work and other others.  
